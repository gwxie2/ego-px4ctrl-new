...
traj_utils_v2::MINCOTraj MINCOTraj_msg_;
...
void one_traj_sub_udp_cb(const traj_utils_v2::MINCOTrajPtr &msg)
{
...
int main(int argc, char **argv)
{
  ...
  one_traj_pub_ = nh.advertise<traj_utils_v2::MINCOTraj>("/broadcast_traj_to_planner", 100);
