...
class SwarmLaunchGenerator:
    ...
    def __init__(self, config_path, output_path, version, uav_count=None):
        ...
        self.mission_manager_script = "swarm_mission_manager.py"
        self.mission_manager_name = "swarm_mission_manager"
    ...
    def _generate_global_args(self):
          ...
          lines.append(self._indent(1, "<arg name=\"benchmark_goal_stop_enabled\" default=\"false\"/>"))
          lines.append(self._indent(1, ""))
          ...
          lines.append(self._indent(1, "<!-- ===== 协同搜索调度 ===== -->"))
          lines.append(self._indent(1, "<arg name=\"enable_mission_manager\" default=\"false\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_manager_mode\" default=\"search\"/>"))
          lines.append(self._indent(1, f"<arg name=\"mission_use_v1\" default=\"{'true' if self.version == 'v1' else 'false'}\"/>"))
          lines.append(self._indent(1, f"<arg name=\"mission_use_v2\" default=\"{'true' if self.version == 'v2' else 'false'}\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_goal_topic\" default=\"/goal_with_id\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_feedback_topic\" default=\"/mission_manager/feedback\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_benchmark_track\" default=\"true\"/>"))
          lines.append(self._indent(1, "<arg name=\"coverage_stop_on_target_detected\" default=\"true\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_goal_reached_radius_m\" default=\"1.0\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_target_confirmation_radius_m\" default=\"1.5\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_support_radius_m\" default=\"8.0\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_search_altitude_m\" default=\"1.5\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_waypoint_spacing_m\" default=\"12.0\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_search_area_min_x\" default=\"-20.0\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_search_area_max_x\" default=\"20.0\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_search_area_min_y\" default=\"-12.0\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_search_area_max_y\" default=\"12.0\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_search_sector_count\" default=\"3\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_explore_speed_mps\" default=\"1.2\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_track_speed_mps\" default=\"2.5\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_support_speed_mps\" default=\"1.8\"/>"))
          lines.append(self._indent(1, "<arg name=\"mission_finish_speed_mps\" default=\"1.0\"/>"))
          lines.append(self._indent(1, ""))
    ...
    def _generate_mission_manager(self):
        ...
        target_positions = ";".join(
            f"{self.uav_configs[drone_id]['goal']['x']},{self.uav_configs[drone_id]['goal']['y']},{self.uav_configs[drone_id]['goal']['z']}"
            for drone_id in sorted(self.uav_configs.keys())
        )
        lines.append(self._indent(1, "<!-- ========================================== -->"))
        lines.append(self._indent(1, "<!-- Cooperative Mission Manager                 -->"))
        lines.append(self._indent(1, "<!-- ========================================== -->"))
        lines.append(self._indent(1, ""))
        lines.append(self._indent(1, '<group if="$(arg enable_mission_manager)">'))
        lines.append(self._indent(2, f'<node pkg="clean_uav_core" type="{self.mission_manager_script}" name="{self.mission_manager_name}" output="screen">'))
        lines.append(self._indent(3, f'<param name="config_file" value="{self.config_path}"/>'))
        lines.append(self._indent(3, f'<param name="planner_node_name" value="{self.benchmark_planner_node_name}"/>'))
        lines.append(self._indent(3, '<param name="mission_manager_mode" value="$(arg mission_manager_mode)"/>'))
        lines.append(self._indent(3, '<param name="mission_use_v1" value="$(arg mission_use_v1)"/>'))
        lines.append(self._indent(3, '<param name="mission_use_v2" value="$(arg mission_use_v2)"/>'))
        lines.append(self._indent(3, '<param name="mission_goal_topic" value="$(arg mission_goal_topic)"/>'))
        lines.append(self._indent(3, '<param name="mission_feedback_topic" value="$(arg mission_feedback_topic)"/>'))
        lines.append(self._indent(3, '<param name="mission_benchmark_track" value="$(arg mission_benchmark_track)"/>'))
        lines.append(self._indent(3, '<param name="output_dir" value="$(arg benchmark_output_dir)/0_mission_manager"/>'))
        ...
        lines.append(self._indent(3, '<param name="odom_topic_template" value="$(arg swarm_odom_topic_template)"/>'))
        lines.append(self._indent(3, '<param name="replan_info_topic_template" value="/drone_%d/$(arg planner_node_name)/planning/replan_info"/>'))
        lines.append(self._indent(3, '<param name="planner_event_topic_template" value="/drone_%d/$(arg planner_node_name)/planning/benchmark_event"/>'))
        lines.append(self._indent(3, '<param name="coverage_metrics_topic" value="/benchmark/coverage_metrics"/>'))
        lines.append(self._indent(3, '<param name="target_detected_topic" value="/benchmark/target_detected"/>'))
        lines.append(self._indent(3, '<param name="benchmark_stop_service" value="/benchmark/stop_session"/>'))
        lines.append(self._indent(3, '<param name="publish_rate" value="$(arg goal_publish_rate)"/>'))
        lines.append(self._indent(3, '<param name="start_delay" value="$(arg goal_start_delay)"/>'))
        lines.append(self._indent(3, '<param name="wait_for_all_uavs" value="$(arg swarm_wait_for_all_uavs)"/>'))
        lines.append(self._indent(3, '<param name="ready_z_threshold" value="$(arg planner_start_z_threshold)"/>'))
        lines.append(self._indent(3, '<param name="ready_stable_duration" value="$(arg planner_start_stable_duration)"/>'))
        lines.append(self._indent(3, '<param name="ready_timeout" value="$(arg planner_start_timeout)"/>'))
        lines.append(self._indent(3, '<param name="ready_post_delay" value="0.0"/>'))
        lines.append(self._indent(3, '<param name="goal_reached_radius_m" value="$(arg mission_goal_reached_radius_m)"/>'))
        lines.append(self._indent(3, '<param name="target_confirmation_radius_m" value="$(arg mission_target_confirmation_radius_m)"/>'))
        lines.append(self._indent(3, '<param name="support_radius_m" value="$(arg mission_support_radius_m)"/>'))
        lines.append(self._indent(3, '<param name="search_altitude_m" value="$(arg mission_search_altitude_m)"/>'))
        lines.append(self._indent(3, '<param name="waypoint_spacing_m" value="$(arg mission_waypoint_spacing_m)"/>'))
        lines.append(self._indent(3, '<param name="search_area_min_x" value="$(arg mission_search_area_min_x)"/>'))
        lines.append(self._indent(3, '<param name="search_area_max_x" value="$(arg mission_search_area_max_x)"/>'))
        lines.append(self._indent(3, '<param name="search_area_min_y" value="$(arg mission_search_area_min_y)"/>'))
        lines.append(self._indent(3, '<param name="search_area_max_y" value="$(arg mission_search_area_max_y)"/>'))
        lines.append(self._indent(3, '<param name="search_sector_count" value="$(arg mission_search_sector_count)"/>'))
        lines.append(self._indent(3, '<param name="explore_speed_mps" value="$(arg mission_explore_speed_mps)"/>'))
        lines.append(self._indent(3, '<param name="track_speed_mps" value="$(arg mission_track_speed_mps)"/>'))
        lines.append(self._indent(3, '<param name="support_speed_mps" value="$(arg mission_support_speed_mps)"/>'))
        lines.append(self._indent(3, '<param name="finish_speed_mps" value="$(arg mission_finish_speed_mps)"/>'))
    ...
    def _generate_dynamic_commander(self):
        ...
        lines.append(self._indent(1, "<!-- ========================================== -->"))
        lines.append(self._indent(1, ""))
        lines.append(self._indent(1, '<group unless="$(arg enable_mission_manager)">'))
        lines.append(self._indent(2, f"<node pkg=\"clean_uav_core\" type=\"{self.commander_script}\" name=\"{self.commander_name}\" output=\"screen\">"))
    ...
    def _generate_benchmark_manager(self):
        ...
        start_xs = ",".join(f"{self.uav_configs[drone_id]['start']['x']}" for drone_id in sorted(self.uav_configs.keys()))
        start_ys = ",".join(f"{self.uav_configs[drone_id]['start']['y']}" for drone_id in sorted(self.uav_configs.keys()))
        start_zs = ",".join(f"{self.uav_configs[drone_id]['start']['z']}" for drone_id in sorted(self.uav_configs.keys()))
        target_positions = ";".join(
            f"{self.uav_configs[drone_id]['goal']['x']},{self.uav_configs[drone_id]['goal']['y']},{self.uav_configs[drone_id]['goal']['z']}"
            for drone_id in sorted(self.uav_configs.keys())
        )
        ...
        lines.append(self._indent(2, "<group if=\"$(arg enable_mission_manager)\">"))
        lines.append(self._indent(3, "<node pkg=\"clean_uav_core\" type=\"benchmark_manager.py\" name=\"benchmark_manager\" output=\"screen\">"))
        lines.append(self._indent(4, f"<param name=\"planner_node_name\" value=\"{self.benchmark_planner_node_name}\"/>"))
        lines.append(self._indent(4, f"<param name=\"drone_count\" value=\"{self.num_uavs}\"/>"))
        lines.append(self._indent(4, "<param name=\"output_dir\" value=\"$(arg benchmark_output_dir)\"/>"))
        lines.append(self._indent(4, "<param name=\"record_rosbag\" value=\"$(arg benchmark_record_rosbag)\"/>"))
        lines.append(self._indent(4, "<param name=\"low_speed_threshold\" value=\"$(arg benchmark_low_speed_threshold)\"/>"))
        lines.append(self._indent(4, "<param name=\"low_speed_duration\" value=\"$(arg benchmark_low_speed_duration)\"/>"))
        lines.append(self._indent(4, "<param name=\"goal_distance_threshold\" value=\"$(arg benchmark_goal_distance_threshold)\"/>"))
        lines.append(self._indent(4, "<param name=\"goal_stop_enabled\" value=\"$(eval str(arg('mission_manager_mode')).lower() != 'search')\"/>"))
        lines.append(self._indent(4, "<param name=\"stop_after_terminal_sec\" value=\"$(arg benchmark_stop_after_terminal_sec)\"/>"))
        lines.append(self._indent(4, "<param name=\"safety_margin_threshold\" value=\"$(arg benchmark_safety_margin_threshold)\"/>"))
        lines.append(self._indent(4, "<param name=\"actuator_saturation_threshold\" value=\"$(arg benchmark_actuator_saturation_threshold)\"/>"))
        lines.append(self._indent(4, "<param name=\"default_vmax\" value=\"$(arg benchmark_default_vmax)\"/>"))
        lines.append(self._indent(4, f"<param name=\"default_drone_ids\" value=\"{','.join(str(drone_id) for drone_id in sorted(self.uav_configs.keys()))}\"/>"))
        lines.append(self._indent(4, f"<param name=\"default_goal_xs\" value=\"{start_xs}\"/>"))
        lines.append(self._indent(4, f"<param name=\"default_goal_ys\" value=\"{start_ys}\"/>"))
        lines.append(self._indent(4, f"<param name=\"default_goal_zs\" value=\"{start_zs}\"/>"))
        lines.append(self._indent(4, "<rosparam command=\"load\" file=\"$(find clean_uav_core)/config/benchmark_research/search_hidden_target_v2.yaml\"/>"))
        lines.append(self._indent(4, "<param name=\"coverage_stop_on_target_detected\" value=\"false\"/>"))
        lines.append(self._indent(3, "</node>"))
        lines.append(self._indent(2, "</group>"))
        lines.append(self._indent(2, "<group unless=\"$(arg enable_mission_manager)\">"))
        lines.append(self._indent(3, "<node pkg=\"clean_uav_core\" type=\"benchmark_manager.py\" name=\"benchmark_manager\" output=\"screen\">"))
        lines.append(self._indent(3, f"<param name=\"planner_node_name\" value=\"{self.benchmark_planner_node_name}\"/>"))
        ...
        lines.append(self._indent(3, "<param name=\"goal_stop_enabled\" value=\"$(eval str(arg('mission_manager_mode')).lower() != 'search')\"/>"))
        ...
        lines.append(self._indent(3, "<rosparam command=\"load\" file=\"$(find clean_uav_core)/config/benchmark_research/search_hidden_target_v2.yaml\"/>"))
        ...
        lines.append(self._indent(3, "<param name=\"coverage_stop_on_target_detected\" value=\"$(arg coverage_stop_on_target_detected)\"/>"))
        lines.append(self._indent(2, "</node>"))
        lines.append(self._indent(2, "</group>"))
        lines.append(self._indent(1, "</group>"))
        lines.append(self._indent(1, ""))
