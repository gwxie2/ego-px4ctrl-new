...
namespace ego_planner
{
  ...
  void EGOReplanFSM::init(ros::NodeHandle &nh)
  {
    ...
    broadcast_ploytraj_pub_ = nh.advertise<traj_utils_v2::MINCOTraj>("planning/broadcast_traj_send", 10);
    broadcast_ploytraj_sub_ = nh.subscribe<traj_utils_v2::MINCOTraj>("planning/broadcast_traj_recv", 100,
                                                                  &EGOReplanFSM::RecvBroadcastMINCOTrajCallback,
                                                                  this,
                                                                  ros::TransportHints().tcpNoDelay());

    poly_traj_pub_ = nh.advertise<traj_utils_v2::PolyTraj>("planning/trajectory", 10);
    data_disp_pub_ = nh.advertise<traj_utils_v2::DataDisp>("planning/data_display", 100);
  ...
  void EGOReplanFSM::publishBenchmarkEvent(uint8_t event_type, FSM_EXEC_STATE previous_state, FSM_EXEC_STATE current_state, const string &caller, bool success)
  {
    ...
    msg.trajectory_id = planner_manager_->traj_.local_traj.traj_id;
    msg.event_type = event_type;
    msg.trigger_reason = replan_trigger_reason_;
    msg.success = success;
    msg.goal_distance = have_target_ ? (odom_pos_ - final_goal_).norm() : -1.0;
    msg.caller = caller;
  ...
  bool EGOReplanFSM::callEmergencyStop(Eigen::Vector3d stop_pos)
  {
    ...
    traj_utils_v2::PolyTraj poly_msg;
  ...
  bool EGOReplanFSM::callReboundReplan(bool flag_use_poly_init, bool flag_randomPolyTraj)
  {
    ...
    publishReplanInfo(plan_success);
    return plan_success;
  }
  ...
  void EGOReplanFSM::publishReplanInfo(bool success)
  {
    ...
    msg.success = success;
    msg.touch_goal = planner_manager_->pp_.touch_goal;
  ...
  void EGOReplanFSM::waypointCallback(const quadrotor_msgs::GoalSetPtr &msg)
  {
    ...
    publishBenchmarkEvent(quadrotor_msgs::PlannerBenchmarkEvent::EVENT_TRIGGER_RECEIVED, exec_state_, exec_state_, "GOAL_SET", true);
  ...
  void EGOReplanFSM::RecvBroadcastMINCOTrajCallback(const traj_utils_v2::MINCOTrajConstPtr &msg)
  {
  ...
  void EGOReplanFSM::polyTraj2ROSMsg(traj_utils_v2::PolyTraj &poly_msg, traj_utils_v2::MINCOTraj &MINCO_msg)
  {
