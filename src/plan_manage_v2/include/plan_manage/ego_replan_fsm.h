...
namespace ego_planner
{
  ...
  private:
    ...
    traj_utils_v2::DataDisp data_disp_;
    ...
    void RecvBroadcastMINCOTrajCallback(const traj_utils_v2::MINCOTrajConstPtr &msg);
    void polyTraj2ROSMsg(traj_utils_v2::PolyTraj &poly_msg, traj_utils_v2::MINCOTraj &MINCO_msg);
