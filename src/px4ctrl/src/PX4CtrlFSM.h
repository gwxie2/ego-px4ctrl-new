...
struct AutoTakeoffLand_t
{
	...
	static constexpr double MOTORS_SPEEDUP_TIME = 2.8; // motors idle running for 2.8 seconds before takeoff
	static constexpr double DELAY_TRIGGER_TIME = 1.8;  // Time to be delayed when reach at target height
};
